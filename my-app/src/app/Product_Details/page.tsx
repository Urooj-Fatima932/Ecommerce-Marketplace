      ...
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex">
            ...
            <button className="flex ml-auto text-white bg-Cblack border-0 py-2 px-6 focus:outline-none  gap-2 hover:bg-gray-600 rounded">
              <ShoppingCart/> Add to Cart
            </button>
            <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-black ml-4">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
